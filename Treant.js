...
;(function( exports ){
  ...
  var Tree = function (jsonConfig, treeId) {
    ...
    this.drawArea = document.getElementById(this.CONFIG.container.substring(0));
    if (this.drawArea) {
      this.drawArea.innerHTML = ''
    } else {
      console.log("drawArea missed")
    }
    //this.drawArea.className += " Treant";
    jQuery(this.drawArea).addClass('Treant')
    ...
    positionTree: function(callback) {
      ...
      if (this.imageLoader.isNotLoading()) {
        ...
        if(!this.loaded) {
          ...
          jQuery(this.drawArea).addClass('Treant-loaded')
